...
# Класс описывает карту игрока, которая создается случайно
...
class Card:
    ...
    def __init__(self):
        ...
        for i in range(self.lines):
            ...
            for a in range(self.cell):
                number = str(numbers_list[a + self.cell * (i - 1)])
    ...
    def __eq__(self, other):
        return self.lines == other.lines and self.cell == other.cell and \
